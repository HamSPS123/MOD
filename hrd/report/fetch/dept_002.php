    ...
    <table class="table table-bordered text-center">
        <thead class="table-primary">
            <tr>
                ...
                <th rowspan="2" class="rotate"><div>ລວມ</div></th>
                <th colspan="4">ແບ່ງປັນ</th>
                <th colspan="3">ຈ່າຍຄ່າຮຽນ</th>
                <th rowspan="2">ສຳພາດ</th>
                <th colspan="2" class="rotate"><div>ນະຄອນຫຼວງ</div></th>
                <th colspan="2" class="rotate"><div>ບໍແກ້ວ</div></th>
                <th colspan="2" class="rotate"><div>ບໍລິຄຳໄຊ</div></th>
                <th colspan="2" class="rotate"><div>ຈຳປາຊັກ</div></th>
                <th colspan="2" class="rotate"><div>ຫົວພັນ</div></th>
                <th colspan="2" class="rotate"><div>ຄຳມວນ</div></th>
                <th colspan="2" class="rotate"><div>ຫຼວງນ້ຳທາ</div></th>
                <th colspan="2" class="rotate"><div>ຫຼວງພະບາງ</div></th>
                <th colspan="2" class="rotate"><div>ອຸດົມໄຊ</div></th>
                <th colspan="2" class="rotate"><div>ຜົງສາລີ</div></th>
                <th colspan="2" class="rotate"><div>ສາລະວັນ</div></th>
                <th colspan="2" class="rotate"><div>ສະຫວັນນະເຂດ</div></th>
                <th colspan="2" class="rotate"><div>ວຽງຈັນ</div></th>
                <th colspan="2" class="rotate"><div>ໄຊຍະບູລີ</div></th>
                <th colspan="2" class="rotate"><div>ເຊກອງ</div></th>
                <th colspan="2" class="rotate"><div>ໄຊສົມບູນ</div></th>
                <th colspan="2" class="rotate"><div>ຊຽງຂວາງ</div></th>
                <th colspan="2" class="rotate"><div>ອັດຕະປື</div></th>
            </tr>
            <tr>
                <th class="rotate"><div>ສະຖາບັນ</div></th>
                <th class="rotate"><div>ສະຖາບັນ (ຮຽນຟຣີ)</div></th>
                <th class="rotate"><div>ພ/ງ</div></th>
                <th class="rotate"><div>ຄູອາສາເບ້ຍລ້ຽງ</div></th>
                <th class="rotate"><div>ນ/ຮ ສາມັນ</div></th>
                <th class="rotate"><div>ພ/ງ</div></th>
                <th class="rotate"><div>ເອກະຊົນ</div></th>
        ...
        <tbody>';
            ...
            <tr style="background: #34a1eb;color: white">
                <td>'. $i .'</td>
                <td style="white-space: nowrap;">'. $row1['group_name'] .'</td>
            ...
            <tr style="background: #34a1eb;color: white">
                <td>'. $roman .'.</td>
                <td class="text-left" style="white-space: nowrap;">'. $row1['uni_name'] .'</td>
            ...
            $table .= '
                <tr>
                    <td colspan="47" style="background: #EDEDED;color: red;">ບໍ່ມີຂໍ້ມູນການແຈກຢາຍ</td>
                </tr>
            ';
        }
        $table .='
