		...
		if (is_string($Harray)) {
			...
			if (strlen($Harray) === 0) {
				...
				if ($this->defaultheaderline) {
					$oddhtml .= ' border-bottom: 0 solid #000000;'; // default value 0.1mm
				}
				...
				if ($this->defaultheaderline) {
					$evenhtml .= ' border-bottom: 0 solid #000000;'; // default value 0.1mm
				}
		...
		if (is_string($Farray)) {
			...
			if (strlen($Farray) == 0) {
				...
				if ($this->defaultfooterline) {
					$oddhtml .= ' border-top: 0 solid #000000;'; // default value 0.1mm
				}
				...
				if ($this->defaultfooterline) {
					$evenhtml .= ' border-top: 0 solid #000000;'; // default value 0.1mm
				}
