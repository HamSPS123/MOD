<?php
  ...
  if(isset($_POST['btnLogin'])){
    $obj->login_hrd($_POST['email'],$_POST['pass']);
  }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                <form action="index" method="POST" id="form_login_admin" class="sign-in-form">
                    ...
                    <button type="submit" class="btn solid" name="btnLogin">ເຂົ້າສູ່ລະບົບ</button>
