        ...
        <div class="dropdown">
            <select name="status" id="status" style="width: 450px;text-align-last: center;" class="form-control">
                ...
                <?php
                    ...
                    $option = mysqli_query($conn, "SELECT adj_id,a.fy_id,a.dept_id,dept_name FROM adjust a LEFT JOIN fy ON a.fy_id=fy.fy_id LEFT JOIN department d ON a.dept_id=d.dept_id LEFT JOIN university u ON d.dept_id=u.dept_id GROUP BY a.adj_id ORDER BY fy_id DESC");
