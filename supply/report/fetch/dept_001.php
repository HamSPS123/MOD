...
<div class="table-responsive tscroll">
    ...
    <table class="table table-bordered text-center">
        <thead class="table-primary">
            <tr>
                <th style="vertical-align: middle" rowspan="3">ລ/ດ</th>
                <th style="vertical-align: middle" rowspan="3">ລາຍລະອຽດ</th>
                <th style="vertical-align: middle" rowspan="3">ລວມ</th>
            ...
            <tr>
                <th colspan="3" style="vertical-align: middle" class="text-nowrap">ນັກຮຽນ</th>
                <th rowspan="2" style="vertical-align: middle" class="text-nowrap">ພ/ງ</th>
                <th rowspan="2" style="vertical-align: middle">ພ/ງ</th>
                <th rowspan="2" style="vertical-align: middle">ນ/ຮ</th>
                <th rowspan="2" style="vertical-align: middle">ນ/ຮ ຕໍ່ເນື່ອງ</th>
                <th rowspan="2" style="vertical-align: middle">ຊາວໜຸ່ມແຮກສ່ຽວ</th>
                <th rowspan="2" style="vertical-align: middle" class="text-nowrap">ນ/ຮ</th>
                <th rowspan="2" style="vertical-align: middle" class="text-nowrap">ພ/ງ</th>
                <th rowspan="2" style="vertical-align: middle" class="text-nowrap">ນ/ຮ</th>
                <th rowspan="2" style="vertical-align: middle" class="text-nowrap">ພ/ງ</th>
                <th rowspan="2" style="vertical-align: middle" class="text-nowrap">ນ/ຮ</th>
            ...
            <tr>
                <th style="vertical-align: middle">ມະຫາວິທະຍາໄລເລືອກ(ໃນແຜນ)</th>
                <th style="vertical-align: middle">
                    ມະຫາວິທະຍາໄລເລືອກແບ່ງໃຫ້ຄູອາສາສະໝັກມາຮຽນລະບົບຕໍ່ເນື່ອງ (ໃນແຜນ)</th>
                <th style="vertical-align: middle">ແຂວງ/ນະຄອນຫຼວງເລືອກ</th>
            </tr>
        </thead>
        <tbody>
';
