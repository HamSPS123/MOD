...
';
          ...
          $table .= '
            ...
            LEFT JOIN department d ON u.dept_id=d.dept_id
            LEFT JOIN adjust a ON ad.adj_id=a.adj_id
            WHERE ad.adj_id='162' AND d.dept_id='001' AND f.uni_id='$uni_id' GROUP BY f.fac_id ORDER BY fac_id ASC;");
          ...
          $table .= '
            ...
            WHERE ad.adj_id='162' AND d.dept_id='001' AND f.uni_id='$uni_id' AND c.fac_id='$fac_id' ORDER BY level_name ASC,course_id ASC;");
            $k = 0;
